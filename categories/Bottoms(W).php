...
<body>
                ...
                <?php foreach ($products as $product): ?>
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            ...
                            <a href="product_detail.php?id=<?= $product['product_id'] ?>" class="cta-button">View Details</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                <p>No Bottoms found for women.</p>
            <?php endif; ?>
        </div>
    </main>
    ...
    <footer class="footer">
        <div class="social-links">
            ...
            <a href="https://www.google.com/maps/place/Shoosports/@33.5557082,35.3968174,17z/data=!3m1!4b1!4m6!3m5!1s0x151eef2c75d507a3:0xa00e0d07c0836fba!8m2!3d33.5557082!4d35.3968174!16s%2Fg%2F11jt2j209r?entry=ttu">
